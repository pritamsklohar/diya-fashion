                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className='relative'>
                                    ...
                                    />
                                    {/* {
                                    showPassword ? <EyeOff className='w-5 h-5 text-gray-700 absolute right-5 bottom-2' onClick={()=>setShowPassword(false)}/>: <Eye onClick={()=>setShowPassword(true)} className='w-5 h-5 text-gray-700 absolute right-5 bottom-2'/>
                                } */}
