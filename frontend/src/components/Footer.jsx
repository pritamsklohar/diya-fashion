    ...
    <footer className='bg-white border-t border-pink-100'>
      <div className='max-w-7xl mx-auto px-4 py-12 grid gap-8 md:grid-cols-4'>
        ...
        <div className='space-y-3'>
          ...
          <ul className='text-sm text-slate-600 space-y-2'>
            <li className='cursor-pointer' onClick={() => navigate(`/products`)}>Kurti</li>
            <li className='cursor-pointer' onClick={() => navigate(`/products`)}>Suit</li>
            <li className='cursor-pointer' onClick={() => navigate(`/products`)}>Lehenga</li>
            <li className='cursor-pointer' onClick={() => navigate(`/products`)}>Dress</li>
          </ul>
        </div>
        ...
        <div className='space-y-3'>
          ...
          <div className='flex items-center gap-3 text-xl text-pink-500'>
            <a target='_blank' rel='noreferrer' href="https://www.instagram.com/diyafashion_kalandri/">
      ...
      <div>
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent>
              <DialogHeader>
                <DialogTitle className='font-bold text-center text-2xl'>Contact Us</DialogTitle>
                <DialogDescription>
                  <div className='mt-2 space-y-4 text-left'>
                    <p className='text-xl font-semibold'>
                      Contact: <span className='text-gray-500 font-light'>6377235823</span>
                    </p>
                    <p className='text-xl font-semibold'>
                      Visit Us:
                    ...
                    <a
                      className='font-semibold text-xl inline-flex items-center gap-2'
                      target='_blank'
                      rel='noreferrer'
                      href="https://www.instagram.com/diyafashion_kalandri/"
                    >
                      <FaInstagram /> Diya Fashion Kalandri
                    </a>
                  </div>
                </DialogDescription>
              </DialogHeader>
